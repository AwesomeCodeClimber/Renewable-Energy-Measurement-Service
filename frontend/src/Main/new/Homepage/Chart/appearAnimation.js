...
export default  function drawAppearAnimation (parentElement, classKey, percentSize, index) {
    ...
    else if(1440 <= window.innerWidth < 1920) elemWidth = Math.sqrt(percentSize) * 60;
    else if(1200 <= window.innerWidth < 1440) elemWidth = Math.sqrt(percentSize) * 55;
    else if(window.innerWidth < 1200 ) elemWidth = Math.sqrt(percentSize) * 50;
     ...
     */
    console.log((window.innerWidth - elemWidth) / 2)
    switch (index) {
        case 0:
